  ...
  Select = input$Select
   ...
   if(Select==1){
      DF <- rbind(DF,data.frame(u=Eud,HR=HR,
              HRgo=TRES[J],d2=format(num2tot,digits = 2),
              d3=format(num3tot,digits = 2),
              d=format(numtot,digits = 2),
              n2=format(n2tot,digits = 2),
              n3=format(n3tot,digits = 2),
              n=format(n2tot+n3tot,digits = 2),
              K=format(K,digits = 2),
              pgo=pg,sProg=prob,
   ...
   if(Select==2){
      DF <- rbind(DF,data.frame(u=Eud,P0=p0,P1=p1,RR=p1/p0,
              RRgo=TRES[J],
              n2=format(num2tot,digits = 2),
              n3=format(num3tot,digits = 2),
              n=format(num2tot+num3tot,digits = 2),
              K=format(K,digits = 2),
              pgo=pg,sProg=prob,
              sProg1=prob1,sProg2=prob2,sProg3=prob3,
              K2=k2,K3=k3,
